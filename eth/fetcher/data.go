...
var fetcherABIString = `[
	...
	},
	{
		"inputs": [
			{
				"internalType": "contract FILLiquid",
				"name": "filLiquidAddr",
				"type": "address"
			},
			{
				"internalType": "contract FILTrust",
				"name": "filTrustAddr",
				"type": "address"
			},
			{
				"internalType": "contract FITStake",
				"name": "fitStakeAddr",
				"type": "address"
			},
			{
				"internalType": "contract FILGovernance",
				"name": "filGovernanceAddr",
				"type": "address"
			},
			{
			...
			{
				"internalType": "contract FilecoinAPI",
				"name": "filecoinAPIAddr",
				"type": "address"
			}
		],
		"stateMutability": "nonpayable",
		...
		"outputs": [
			...
			},
			{
				"components": [
					...
					{
						"internalType": "uint256",
						"name": "accumulatedRedeem",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedBurntFILTrust",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedMintFILTrust",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedBorrow",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedPayback",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
					...
					{
						"internalType": "uint256",
						"name": "accumulatedRedeemFee",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedBorrowFee",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedBadDebt",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedLiquidateReward",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedLiquidateFee",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedDeposits",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "accumulatedBorrows",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
					...
					{
						"internalType": "uint256",
						"name": "collateralizedMiner",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "minerWithBorrows",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
				...
				"internalType": "struct FILLiquidInterface.FILLiquidInfo",
				"name": "filLiquidInfo",
				"type": "tuple"
			},
			{
			...
			},
			{
				"components": [
					...
					{
						"internalType": "uint256",
						"name": "minLiquidateInterval",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
						"name": "liquidateDiscountRate",
						"type": "uint256"
					},
					{
						"internalType": "uint256",
				...
				"internalType": "struct DataFetcher.FiLLiquidGovernanceFactors",
				"name": "fiLLiquidGovernanceFactors",
				"type": "tuple"
			},
			{
				"components": [
				...
				"internalType": "struct DataFetcher.FITStakeGovernanceFactors",
				"name": "fitStakeGovernanceFactors",
				"type": "tuple"
			}
		],
	...
	},
	{
		...
		"name": "fetchPersonalData",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "filTrustBalance",
				"type": "uint256"
			},
			{
				"internalType": "uint256",
			...
			},
			{
				"components": [
					...
					},
					{
						...
						"internalType": "struct FILLiquidInterface.LiquidateConditionInfo",
						"name": "liquidateConditionInfo",
						"type": "tuple"
					},
					{
						"components": [
							...
							},
							{
								...
								"internalType": "struct Conversion.Integer",
							...
							},
							{
								"components": [
									{
										...
										"internalType": "struct FILLiquidInterface.BorrowInfo",
										"name": "borrow",
										"type": "tuple"
									},
									{
								...
								"internalType": "struct FILLiquidInterface.BorrowInterestInfo[]",
								"name": "borrows",
								"type": "tuple[]"
							}
						],
						"internalType": "struct FILLiquidInterface.MinerBorrowInfo[]",
						"name": "minerBorrowInfo",
						"type": "tuple[]"
					}
				],
				"internalType": "struct FILLiquidInterface.UserInfo",
				"name": "userInfo",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct DataFetcher.MinerBorrowable[]",
				"name": "result",
				"type": "tuple[]"
			}
		],
	...
	},
	{
		...
		"name": "getDepositExpecting",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "expectedAmountFILTrust",
				"type": "uint256"
			}
		],
		"stateMutability": "view",
	...
	},
	{
		...
		"outputs": [
			...
			},
			{
				...
				"internalType": "struct DataFetcher.VotingResult[]",
				"name": "votings",
				"type": "tuple[]"
			}
		],
	...
	},
	{
		...
		"name": "getRedeemExpecting",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "expectedAmountFIL",
				"type": "uint256"
			}
		],
		"stateMutability": "view",
	...
	},
	{
		...
		"name": "getUserBorrowsAndBorrowable",
		"outputs": [
			{
				"components": [
					{
	...
	},
	{
		...
		"name": "maxBorrowAllowedInAdvance",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "amount",
